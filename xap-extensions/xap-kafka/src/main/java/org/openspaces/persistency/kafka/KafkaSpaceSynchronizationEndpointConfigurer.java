...
public class KafkaSpaceSynchronizationEndpointConfigurer {
    ...
    public KafkaSpaceSynchronizationEndpoint create() {
        ...
        KafkaSpaceSynchronizationEndpoint kafkaSpaceSynchronizationEndpoint = secondaryEndpoints == null ? new KafkaSpaceSynchronizationEndpoint(primaryEndpoint, kafkaProperties, topic) : new KafkaSpaceSynchronizationEndpoint(primaryEndpoint, secondaryEndpoints, kafkaProperties, topic);
