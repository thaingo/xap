...
@InternalApi
public class KafkaDataSyncOperation implements Externalizable, DataSyncOperation {
    ...
    public KafkaDataSyncOperation() {
    }

    public KafkaDataSyncOperation(DataSyncOperation dataSyncOperation) {
